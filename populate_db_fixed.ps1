...
foreach ($usuario in $usuarios) {
    try {
        ...
        Write-Host "⚠️  Usuario $($usuario.username) ya existe" -ForegroundColor Yellow
    }
}
...
$actividades = @(
    ...
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Lunes"; horarioInicio="19:00"; horarioFinal="20:00"; cupo=20},
            @{dia="Miércoles"; horarioInicio="19:00"; horarioFinal="20:00"; cupo=20},
            @{dia="Viernes"; horarioInicio="19:00"; horarioFinal="20:00"; cupo=20}
        )
    },
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Martes"; horarioInicio="07:00"; horarioFinal="08:00"; cupo=25},
            @{dia="Jueves"; horarioInicio="07:00"; horarioFinal="08:00"; cupo=25},
            @{dia="Sábado"; horarioInicio="09:00"; horarioFinal="10:00"; cupo=25}
        )
    },
    @{
        nombre = "Pilates Mat"
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Martes"; horarioInicio="10:00"; horarioFinal="11:00"; cupo=12},
            @{dia="Jueves"; horarioInicio="10:00"; horarioFinal="11:00"; cupo=12}
        )
    },
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Lunes"; horarioInicio="18:00"; horarioFinal="19:00"; cupo=18},
            @{dia="Miércoles"; horarioInicio="18:00"; horarioFinal="19:00"; cupo=18},
            @{dia="Viernes"; horarioInicio="07:00"; horarioFinal="08:00"; cupo=18}
        )
    },
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Martes"; horarioInicio="19:00"; horarioFinal="20:00"; cupo=30},
            @{dia="Jueves"; horarioInicio="19:00"; horarioFinal="20:00"; cupo=30},
            @{dia="Sábado"; horarioInicio="10:00"; horarioFinal="11:00"; cupo=30}
        )
    },
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Lunes"; horarioInicio="20:00"; horarioFinal="21:00"; cupo=16},
            @{dia="Miércoles"; horarioInicio="20:00"; horarioFinal="21:00"; cupo=16},
            @{dia="Viernes"; horarioInicio="20:00"; horarioFinal="21:00"; cupo=16}
        )
    },
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Martes"; horarioInicio="06:00"; horarioFinal="07:00"; cupo=10},
            @{dia="Jueves"; horarioInicio="06:00"; horarioFinal="07:00"; cupo=10},
            @{dia="Sábado"; horarioInicio="08:00"; horarioFinal="09:00"; cupo=10}
        )
    },
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Lunes"; horarioInicio="12:00"; horarioFinal="13:00"; cupo=20},
            @{dia="Miércoles"; horarioInicio="12:00"; horarioFinal="13:00"; cupo=20},
            @{dia="Viernes"; horarioInicio="12:00"; horarioFinal="13:00"; cupo=20}
        )
    },
    @{
        ...
        owner_id = $ADMIN_ID
        horarios = @(
            @{dia="Martes"; horarioInicio="18:00"; horarioFinal="19:00"; cupo=25},
            @{dia="Jueves"; horarioInicio="18:00"; horarioFinal="19:00"; cupo=25}
        )
    }
)
...
Write-Host "`n[OK] Base de datos poblada exitosamente!" -ForegroundColor Green
Write-Host "Resumen:" -ForegroundColor Cyan
Write-Host "   - 1 Admin (admin / admin)" -ForegroundColor White
Write-Host "   - 3 Usuarios normales" -ForegroundColor White
Write-Host "   - 10 Actividades con multiples horarios" -ForegroundColor White
Write-Host "`nLas actividades deberian estar indexadas en Solr automaticamente" -ForegroundColor Cyan
Write-Host "Los datos estan en MongoDB y PostgreSQL" -ForegroundColor Cyan
Write-Host "`nAhora recarga la pagina localhost:3000 y deberias ver las actividades!" -ForegroundColor Green
